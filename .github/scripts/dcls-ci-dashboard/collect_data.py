...
"""Collect CI run/job data from GitHub API for the DCLS CVA6 CI Dashboard.
...
Tracks three workflows:
  ...
  dcls-ci-tier1   — dcls-ci-tier1.yml (DCLS Tier 1 PR Gate)
  dcls-ci-tier2   — dcls-ci-tier2.yml (DCLS Tier 2 Nightly, future)
"""
...
WORKFLOWS = {
    "ci":             "ci.yml",
    "dcls-ci-tier1":  "dcls-ci-tier1.yml",
    "dcls-ci-tier2":  "dcls-ci-tier2.yml",
}
...
def main():
    parser = argparse.ArgumentParser(description="Collect DCLS CVA6 CI data from GitHub API")
    parser.add_argument(
        "--repo",
        default=os.environ.get("GITHUB_REPOSITORY", "AlexChenIC/cva6-rigoletto-ci"),
