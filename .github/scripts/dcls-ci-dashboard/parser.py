...
"""Parse CI job names into structured data for the DCLS CVA6 CI Dashboard.
...
Handles three job name formats:
  ...
  Format 3 — DCLS Tier 1 (dcls-ci-tier1.yml):
...
def parse_job_name(job_name: str, workflow_name: str) -> Optional[dict]:
    ...
    # ------------------------------------------------------------------
    # Format 3 — DCLS Tier 1 (dcls-ci-tier1.yml / dcls-ci-tier2.yml)
...
if __name__ == "__main__":
    # Quick self-test
    test_cases = [
        # Format 3 — DCLS Tier 1
        ("smoke-tests-dcls (cv32a60x)", "dcls-ci-tier1"),
        ("dv-riscv-arch-test (cv32a60x)", "dcls-ci-tier1"),
        ("dv-riscv-arch-test (cv32a65x)", "dcls-ci-tier1"),
        ("dv-riscv-tests-p (cv32a60x)", "dcls-ci-tier1"),
        ...
        # Skip jobs
        ("Setup Tools", "dcls-ci-tier1"),
        ("Test Summary", "dcls-ci-tier1"),
        ("Build Dashboard", "dcls-ci-dashboard"),
    ]
