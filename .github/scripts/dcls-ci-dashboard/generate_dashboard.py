...
"""Generate DCLS CVA6 CI Dashboard HTML from collected JSON data.
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate DCLS CVA6 CI Dashboard HTML"
    )
    parser.add_argument(
        "--data-dir",
        default="data",
    ...
    default_matrix_wf = "dcls-ci-tier1"
    if not all_data.get("dcls-ci-tier1"):
        for wf in WORKFLOW_INFO:
